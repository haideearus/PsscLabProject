...
namespace PsscFinalProject.Domain.Models
{
    ...
    public class ShoppingCart
    {
        ...
        private readonly ClientRepository clientRepository; // Client repository to fetch clients

        // Constructor to initialize client repository
        public ShoppingCart(int clientId, string clientEmail, ClientRepository clientRepository)
        {
            ClientId = clientId;
        ...
        public async Task<Order> PlaceOrderAsync(string shippingAddress)
        {
            ...
            ClientDto clientDto = await clientRepository.GetClientByIdAsync(ClientId);
            Client client = MappingOperations.MapToDomain(clientDto);
